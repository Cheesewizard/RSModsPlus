...
### Recording (F9 and overlay Record button)
...
- [ ] Overlay Note by Note page: show/hide readout, readout and target size, target Left/Center/Custom, four detection colours with live preview; all saved to `RSMods.ini`.
