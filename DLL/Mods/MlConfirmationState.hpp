...
namespace NoteByNoteDetection
{
	...
	public:
		...
		bool Observe(const NoteByNoteProtocol::MlNoteEvidence& evidence)
		{
			if (evidence.verdict != NoteByNoteProtocol::MlNoteVerdict::Confirmed
