...
int DropPedal::GetAppliedInputShiftSemitones()
{
	...
	// post-processing consumer observes (the raw pitch verifier above all: measuring at
	// the physical frequency while the shifter transposes the route made tier-0 veto the
	// player's own correct notes under Speaker Mode, 2026-08-31 night). 0 whenever the
	// shifter is inactive or the pedal is off.
