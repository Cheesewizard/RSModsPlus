...
2. Verify RS_ASIO v0.7.5 and chain its existing PortAudio unmarshal patch.
...
| Condition | Behaviour |
|---|---|
| RS_ASIO v0.7.5 is not loaded | ASIO processing remains disabled |
| The supported PortAudio capture point is not found exactly once | ASIO processing remains disabled |
...
The v0.7.5 capture integration was validated live in single player with a
