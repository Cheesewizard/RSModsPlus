...
namespace RSMods
{
    public partial class MainForm : Form
    {
        ...
        private void FillToolTipDictionary()
        {
            ...
            TooltipDictionary.Add(checkBox_ModernCableInput, "Experimental Windows audio input path, off by default. Enable only for testing.\nOther Windows audio input devices can use this path, but third-party compatibility is unverified; your device may not work.\nWhen off, this feature leaves input opening unchanged. Stands down when RS_ASIO is installed. Restart Rocksmith after changes.");
